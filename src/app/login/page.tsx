        ...
        <div className="dark-panel relative overflow-hidden rounded-[40px] px-7 py-8 sm:px-10 sm:py-10">
          ...
          <div className="relative space-y-8">
            <div className="space-y-4">
              <p className="section-label text-white/65">Phase 2 Access</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[28px] border border-white/12 bg-white/8 p-5 backdrop-blur">
                <p className="text-xs uppercase tracking-[0.28em] text-white/45">Why sign in</p>
              ...
              <div className="rounded-[28px] border border-white/12 bg-[linear-gradient(180deg,rgba(255,205,117,0.16),rgba(255,255,255,0.06))] p-5">
                <p className="text-xs uppercase tracking-[0.28em] text-white/45">Demo access</p>
                <div className="mt-4 space-y-3 text-sm leading-7 text-white/80">
                  <p>
                    Member: <code className="rounded bg-white/10 px-2 py-1 text-white">demo@addisbeakal.test</code>
                  </p>
                  <p>
                    Password: <code className="rounded bg-white/10 px-2 py-1 text-white">demo12345</code>
                  </p>
                  <p>
                    Admin: <code className="rounded bg-white/10 px-2 py-1 text-white">admin@addisbeakal.test</code>
                  </p>
                  <p>
                    Password: <code className="rounded bg-white/10 px-2 py-1 text-white">admin12345</code>
                  </p>
                </div>
              </div>
            </div>
